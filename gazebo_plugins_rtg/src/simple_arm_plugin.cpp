...
public: void OnUpdate(const common::UpdateInfo & /*_info*/)
    {
        ...
        this->model->GetJointController()->SetPositionTarget("6dof_arm::6dof_arm::base",this->acilar[0]);
        this->model->GetJointController()->SetPositionTarget("6dof_arm::6dof_arm::base2",this->acilar[1]);
        this->model->GetJointController()->SetPositionTarget("6dof_arm::6dof_arm::shoulder",this->acilar[2]);
        this->model->GetJointController()->SetPositionTarget("6dof_arm::6dof_arm::shoulder2",this->acilar[3]);
        this->model->GetJointController()->SetPositionTarget("6dof_arm::6dof_arm::elbow",this->acilar[4]);
        this->model->GetJointController()->SetPositionTarget("6dof_arm::6dof_arm::elbow2",this->acilar[5]);
...
public: void publishOdometry()
    {
        ...
        if((current_time-last_time).toSec()>0.1)
        {
            ...
            tf::Quaternion qt;
            tf::Vector3 vt;
            ignition::math::Pose3d pose = this->model->GetLink("6dof_arm::6dof_arm::link_uc")->WorldPose();
