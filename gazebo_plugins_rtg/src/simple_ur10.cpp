...
public: void Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
    {
        ...
        gazebo::common::PID PID = gazebo::common::PID(2000,0.99,100);
...
public: void OnUpdate(const common::UpdateInfo & /*_info*/)
    {
        ...
        // this->model->GetJointController()->SetPositionTarget("ur10_arm::ur10::shoulder_pan",this->acilar[0]);
        // this->model->GetJointController()->SetPositionTarget("ur10_arm::ur10::shoulder_lift",this->acilar[1]);
        // this->model->GetJointController()->SetPositionTarget("ur10_arm::ur10::elbow",this->acilar[2]);
        // this->model->GetJointController()->SetPositionTarget("ur10_arm::ur10::wrist_1_joint",this->acilar[3]);
        // this->model->GetJointController()->SetPositionTarget("ur10_arm::ur10::wrist_2_joint",this->acilar[4]);
        // this->model->GetJointController()->SetPositionTarget("ur10_arm::ur10::wrist_3_joint",this->acilar[5]);
        this->model->SetJointPosition("ur10_arm::ur10::shoulder_pan",this->acilar[0]);
        this->model->SetJointPosition("ur10_arm::ur10::shoulder_lift",this->acilar[1]);
        this->model->SetJointPosition("ur10_arm::ur10::elbow",this->acilar[2]);
        this->model->SetJointPosition("ur10_arm::ur10::wrist_1_joint",this->acilar[3]);
        this->model->SetJointPosition("ur10_arm::ur10::wrist_2_joint",this->acilar[4]);
        this->model->SetJointPosition("ur10_arm::ur10::wrist_3_joint",this->acilar[5]);
        publishOdometry();
...
public: void publishOdometry()
    {
        ...
        if((current_time-last_time).toSec()>0.1)
        {
            ...
            tf::Quaternion qt;
            tf::Vector3 vt;
            ignition::math::Pose3d pose = this->model->GetLink("ur10::tip")->WorldPose();
